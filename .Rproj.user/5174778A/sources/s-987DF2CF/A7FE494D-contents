...
df_b_c <- data.frame(boca_cal$...46, B_total_c)

res.aov_b_c <- aov(boca_cal$...46 ~ B_total_c, data = df_b_c)

df_b_p <- data.frame(boca_pre$...50, B_total_p)

res.aov_b_p <- aov(boca_pre$...50 ~ B_total_p, data = df_b_c)
...
df_o_c <- data.frame(ojos_cal$...22, O_total_c)

res.aov_o_c <- aov(ojos_cal$...22 ~ O_total_c, data = df_o_c)

df_o_p <- data.frame(ojos_pre$...26, O_total_p)

res.aov_o_p <- aov(ojos_pre$...26 ~ O_total_p, data = df_o_c)
...
df_c_c <- data.frame(cejas_cal$...6, Cejas_total_c)

res.aov_c_c <- aov(cejas_cal$...6 ~ Cejas_total_c, data = df_c_c)

df_c_p <- data.frame(cejas_pre$...10, Cejas_total_p)

res.aov_c_p <- aov(cejas_pre$...10 ~ Cejas_total_p, data = df_c_c)
...
df_n_c <- data.frame(nariz_cal$...38, N_total_c)

res.aov_n_c <- aov(nariz_cal$...38 ~ N_total_c, data = df_n_c)

df_n_p <- data.frame(nariz_pre$...42, N_total_p)

res.aov_n_p <- aov(nariz_pre$...42 ~ N_total_p, data = df_n_c)
